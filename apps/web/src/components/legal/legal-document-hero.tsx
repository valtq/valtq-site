 ...
 * semantic h1, a short description, and the effective / last-updated
  ...
  return (
    <section className="legal-hero border-b border-white/10 bg-[#0B1E36] text-white">
      <Container className="py-12 sm:py-14 lg:py-16">
        <h1 className="font-display max-w-3xl text-balance text-3xl font-bold leading-[1.15] tracking-[-0.01em] sm:text-4xl sm:leading-[1.15] lg:text-5xl rtl:leading-[1.3]">
          {content.title}
        </h1>
