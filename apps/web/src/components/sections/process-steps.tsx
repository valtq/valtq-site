    ...
    <Section>
      <Container>
        ...
        <div className="relative mt-16">
          <div className="absolute start-4 top-0 h-full w-px bg-border sm:start-1/2 sm:-translate-x-px" />
          ...
          <div className="space-y-12">
            {dict.processSteps.steps.map((step, i) => {
              ...
              return (
                ...
                >
                  <div className="relative z-10 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 border-primary bg-surface-container-lowest font-display text-sm font-bold text-primary sm:mx-auto sm:-translate-x-1/2">
                    {step.number}
                  </div>
