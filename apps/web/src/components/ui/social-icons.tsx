...
/**
 * Brand icons for ValtQ's social channels.
 * Most icons inherit `currentColor` (set via the parent's text color).
 * Instagram uses its official gradient; Snapchat uses its brand yellow.
 */
...
export function SnapchatIcon({ className }: IconProps) {
  return <SiSnapchat className={className} style={{ color: '#FFFC00' }} />;
}
