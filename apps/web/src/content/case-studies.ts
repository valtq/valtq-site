...
export const caseStudies: CaseStudy[] = [
  {
    ...
    challenge: {
      ...
      ar: 'احتاجت NovaPay إلى استبدال نظام المعالجة الدفعية القديم بمنصة تحليلات في الوقت الحقيقي. كان الحل الحالي يستغرق 45 دقيقة لإنشاء التقارير، مما تسبب في تأخيرات حرجة في اكتشاف الاحتيال والامتثال التنظيمي. كان يجب على النظام الجديد التعامل مع الأحماء الذروة خلال ساعات السوق دون تدهور.',
    },
    solution: {
  ...
  },
  {
    ...
    description: {
      ...
      ar: 'تطبيق هاتف متعدد المنصات يبسّط عملية استقبال المرضى وجدولة المواعيد والتوثيق السراني لأكثر من 200 عيادة.',
    },
    tags: [
    ...
    challenge: {
      ...
      ar: 'كانت العيادات تغرق في نماذج الاستقبال الورقية وأنظمة الجدولة المجزأة. تجاوزت معدلات عدم حضور المرضى 30%، مما كلف العيادات الآلاف شهريًا. كانت الحلول الحالية إما معقدةเกิน لتبني الموظفين أو أساسية جدًا للاحتياجات السرانية. أضاف الامتثال لـ HIPAA طبقة أخرى من التعقيد.',
    },
    solution: {
    ...
    results: {
      ...
      ar: 'انخفض وقت استقبال المرضى بنسبة 65%. انخفضت معدلات عدم الحضور بنسبة 42% من خلال التذكيرات التنبؤية. وصل تبني الموظفين إلى 94% خلال الشهر الأول. يتعامل التطبيق مع أكثر من 50,000 مستخدم نشط شهريًا عبر 200 عيادة بأوق تشغيل 99.8%.',
    },
  },
  {
    ...
    description: {
      ...
      ar: 'منصة تجارة إلكترونية بدون واجهة تتعامل مع أكثر من 100,000 مستخدم متزامن خلال المبيعات_flashية بدون وقت توقف.',
    },
    tags: [
      { en: 'Web Application', ar: 'تطبيق ويب' },
      { en: 'Cloud Architecture', ar: 'بنية سحابية' },
      { en: 'E-Commerce', ar: 'تجارة إلكترونية' },
      { en: 'Microservices', ar: 'خدمات المصغرة' },
    ],
    ...
    challenge: {
      ...
      ar: 'انهارت منصة تجارة إلكترونية حزمية موجودة تحت حركة المبيعات اللامعة، مما تسبب في إخفاقات متسلسلة عبر أنظمة الدفع والمخزون والمدفوعات. لم يكن الحزام قابلًا لتوسيع الخدمات بشكل مستقل، مما أدى إلى التوفر الزائد وضياع 60% من البنية التحتية. كان يجب أن يحدث التحويل بدون أي توقف خلال موسم البيع الذروة.',
    },
    solution: {
      ...
      ar: 'فككنا الحزام إلى خدمات المصغرة المدفوعة بالنطاق: الكتالوج والسلة والطلب والدفع والمخزون — كل منها قابل للنشر بشكل مستقل. مكّن نمط Strangler Fig التحويل التدريجي مع أعلام الميزات التي توجه الحركة بين الخدمات القديمة والجديدة. وفر AWS ECS مع Fargate التوسيع التلقائي، بينما خفض التخزين المؤقت CloudFront وRedis أصل الحمل بنسبة 80%. نظام حجز المخزون المخصص منع البيع الزائد خلال المبيعات اللامعة باستخدام القفل الموزع.',
    },
    results: {
      ...
      ar: 'تتعامل المنصة الآن مع أكثر من 100,000 مستخدم متزامن بدون وقت توقف خلال المبيعات اللامعة. انخفض وقت تحميل الصفحة إلى 1.2 ثانية عالميًا. انخفضت تكاليف البنية التحتية بنسبة 35% مع دعم 3 أضعاف الحركة. زادت الإيرادات بنسبة 180% سنويًا مع توسع المنصة في أسواق جديدة.',
    },
  },
  {
    ...
    title: {
      ...
      ar: 'ContentAI — محرك التوصيات الشخصانية',
    },
    description: {
      en: 'An ML-powered recommendation engine increasing user engagement by 3x for a digital media platform.',
      ar: 'محرك توصيات مدعوم بالتعلم الآلي زاد التفاعل المستخدمين 3 مرات لمنصة إعلام رقمي.',
    },
    tags: [
    ...
    metrics: [
      ...
      { label: { en: 'Content Items Indexed', ar: 'عناصر المحتوى المؤشرة' }, value: '5M+' },
    ],
    challenge: {
      ...
      ar: 'اعتمدت منصة إعلام رقمية مع أكثر من 2 مليون مستخدم يومي على الإعداد Notícوي للتوصيات بالمحتوى، مما أدى إلى فقاعات فلترة وتفاعل متراجع. كان نهج التصفية التعاونية الحالي يبدأ بشكل سيء للمستخدمين الجدد والمحتوى الجديد. كان يجب على النظام تقديم توصيات شخصانية في أقل من 50 مللي ثانية مع التعامل مع أكثر من 50,000 طلب في الثانية.',
    },
    solution: {
      ...
      ar: 'بنينا محرك توصيات هجين يجمع بين التصفية التعاونية والتشابه المبني على المحتوى ونموذج التسلسل المبني على المحول للتخصيص على مستوى الجلسة. يسير خط أنابيب التعلم الآلي على Kubernetes مع استدلال مسرّع بـ GPU. يخزن مخزن الميزات م Inserts المستخدمين والعناصر مسبقاً، مما يتيق خدمة أقل من 50 مللي ثانية. بنية اختبار A/B تشغيل تجارب مستمرة لتحسين خوارزميات الترتيب. تم حل مشكلة البداية الباردة عبر م Inserts المحتوى والأولويات الديموغرافية.',
    },
    results: {
      ...
      ar: 'زيادة تفاعل المستخدمين 3 مرات خلال 3 أشهر من النشر. تحسنت معدل اكتشاف المحتوى بنسبة 156%، مما عرّض المستخدمين لمحتوى أكثر تنوعًا. زاد متوسط مدة الجلسة بـ 2.4 دقيقة. يعالج المحرك أكثر من 50,000 توصية في الثانية بدقة صلة 94%.',
    },
  },
];
