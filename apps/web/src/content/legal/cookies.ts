...
export const cookiesDocument: LegalDocument = {
  ...
  content: {
    ...
    ar: {
      ...
      description: 'كيف يستخدم موقع فالتكيو ملفات تعريف الارتباط وتقنيات المتصفح المماثلة.',
      intro:
        'توضح سياسة ملفات تعريف الارتباط هذه كيف يستخدم موقع فالتكيو (ValtQ) ملفات تعريف الارتباط وتقنيات المتصفح المماثلة، وما الذي يُخزَّن على جهازك عند الزيارة، وكيف يمكنك إدارته.',
      sections: [
        {
          id: 'what-are-cookies',
