...
export const privacyDocument: LegalDocument = {
  ...
  content: {
    ...
    ar: {
      ...
      description: 'كيف يجمع موقع فالتكيو المعلومات الشخصية ويستخدمها ويحميها.',
      intro:
        'توضح سياسة الخصوصية هذه كيف يجمع موقع فالتكيو (ValtQ) المعلومات الشخصية ويستخدمها ويحميها عندما تزور موقعنا أو تتواصل معنا. تنطبق على المعلومات المجمعة من خلال هذا الموقع.',
      sections: [
        {
          id: 'introduction',
          heading: '1. مقدمة',
          blocks: [
            {
              type: 'p',
              text: 'فالتكيو هي شركة تطوير برمجيات. تصف هذه السياسة ممارساتنا المتعلقة بالمعلومات الشخصية المرتبطة بهذا الموقع، بما في ذلك نموذج التواصل وأداة الاكتشاف.',
            },
            {
              type: 'p',
