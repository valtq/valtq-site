...
export const termsDocument: LegalDocument = {
  ...
  content: {
    ...
    ar: {
      title: 'شروط الخدمة',
      description: 'القواعد المنظمة لاستخدام موقع فالتكيو ومحتواه وأدوات التواصل الخاصة به.',
      intro:
        'تحكم شروط الخدمة هذه ("الشروط") وصولك إلى موقع فالتكيو (ValtQ) واستخدامك له، وكذلك المعلومات والأدوات والخدمات التي يتيحها. باستخدامك هذا الموقع فإنك توافق على هذه الشروط.',
      sections: [
        {
          id: 'acceptance',
          ...
          blocks: [
            {
              type: 'p',
              text: 'بوصولك إلى موقع فالتكيو أو استخدامه، فإنك تؤكد أنك قرأت هذه الشروط وفهمتها وتوافق على الالتزام بها. إذا كنت لا توافق على أي جزء من هذه الشروط، فيرجى عدم استخدام الموقع.',
            },
            {
              type: 'notice',
              tone: 'info',
        ...
        },
        {
          ...
          blocks: [
            {
              type: 'p',
              text: 'فالتكيو هي شركة تطوير برمجيات تقدم خدمات تطوير مواقع الويب والتطبيقات والذكاء الاصطناعي والحلول السحابية والخلفية (Backend). يعرض هذا الموقع شركتنا وخدماتنا وأعمالنا المختارة والمحتوى ذا الصلة، ويتيح طرقًا للتواصل معنا.',
            },
            {
              type: 'p',
              text: 'تشير عبارات "نحن" أو "إياكم" أو "لنا" إلى فالتكيو والفريق الذي يدير هذا الموقع.',
            },
          ],
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                'انتحال شخصية فالتكيو أو تحريف علاقتك بنا.',
        ...
        },
        {
          ...
          blocks: [
            {
              type: 'p',
              text: 'التصميم والنصوص والرسومات والشعارات والمحتوى الآخر في هذا الموقع ملك لفالتكيو أو لمرخّصيها وتحميه قوانين الملكية الفكرية المعمول بها.',
            },
            {
              type: 'p',
        ...
        },
        {
          ...
          blocks: [
            {
              type: 'p',
              text: 'إلى أقصى حد يسمح به القانون المعمول به، لا تكون فالتكيو مسؤولة عن الأضرار غير المباشرة أو العرضية أو التبعية أو التعويضية، أو عن فقدان الأرباح أو البيانات أو السمعة، الناشئة عن استخدامك للموقع أو المتعلقة به.',
            },
            {
              type: 'notice',
              tone: 'caution',
